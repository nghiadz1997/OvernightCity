          ...
          <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs space-y-3">
            ...
            <div class="space-y-2 text-xs">
              ...
              <div class="flex items-center justify-between py-1">
                ...
                ${item.senderPhone ? `
                  <a href="tel:${item.senderPhone}" class="font-bold text-blue-600 hover:text-blue-800 flex items-center gap-1.5 bg-blue-50 px-2.5 py-0.5 rounded-md border border-blue-200 text-xs">
